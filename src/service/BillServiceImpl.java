...
//method call to avoid path travesal		
		...
		if (f.exists()) {
			directory = "http://localhost:" + req.getLocalPort()
					...
					+ "/certificates/" + registration + "_certificates.pdf";
			//failIfDirectoryTraversal(directory);
	...
	public String getSsoId(String machineId) {
		return billDAO.getSsoId(machineId);
	}

	@Override
	public void updatePaymentMode(String transactionId, String paymentCode) {
		// TODO Auto-generated method stub
		billDAO.updatePaymentMode(transactionId , paymentCode);
	}
