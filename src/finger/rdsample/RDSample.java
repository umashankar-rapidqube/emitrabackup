...
import finger.model.Opts;
import finger.model.PidOptions;
...
public class RDSample {
	...
	private String timoutValues[] = { "10000", "20000", "30000", "40000", "50000", "60000", "70000", "80000", "90000",
			"100000", "0" };
	...
	private String MygetPIDOptions() {
		try {
			...
			logger.error("RDSample, Exception in MygetPIDOptions : " + e.getMessage());
			/* e.printStackTrace(); */
		}
		return null;
	}
	...
	public boolean MyDiscoverRDService(String strRDName) {
		...
		for (int i = 11100; i <= 11120; i++) {
			...
			try {
				 ...
				 * 
				 * String line = null; String res = ""; while ((line = rd.readLine()) != null) {
				 * res += line; }
				 */
				...
				logger.error("RDSample, Exception in MyDiscoverRDService : " + e.getMessage());
				/* e.printStackTrace(); */
			}
			finally {
				try {
