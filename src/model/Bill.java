...
public class Bill {
	...
	public String getServiceProviderPage() {
		return serviceProviderPage;
	}

	public void setServiceProviderPage(String serviceProviderPage) {
		this.serviceProviderPage = serviceProviderPage;
	}
