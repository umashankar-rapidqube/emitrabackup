						...
						<div class="fourservices">
							<div class="innermid">
										...
										<div class="billmidmain">
											...
											<div class="col-md-3 deg30">
												<div class="grevanceservices">
													<c:if test="${bill.langCode == 0}">
														<a href="javascript:void(0);" onclick="getSP1('tokenVerification' , 'utilityBills')"class="panel">
															<img src="img/Get-status.png" alt="" />
															<span>Get Status of E-mitra Transactions</span>
														</a>
													</c:if>
													<c:if test="${bill.langCode == 1}">
														<a href="javascript:void(0);" onclick="getSP1('tokenVerificationHi' , 'utilityBills')"class="panel">
															<img src="img/Get-status.png" alt="" />
															<span>ई-मित्र ट्रांन्जेकशन की स्थिति प्राप्त करें</span>
														</a>
													</c:if>
												</div>
											</div>
											...
											<div class="col-md-3 deg60">
												<div class="grevanceservices">
													<c:if test="${bill.langCode == 0}">
														<a href="javascript:void(0);" onclick="getSP1('Exam' , 'utilityBills')"class="panel">
															<img src="img/sexam.png" alt="" />
															<span>View Secondary Exam Detail B.S.E.R., Ajmer</span>
														</a>
													</c:if>
													<c:if test="${bill.langCode == 1}">
														<a href="javascript:void(0);" onclick="getSP1('ExamHi' , 'utilityBills')"class="panel">
															<img src="img/sexam.png" alt="" />
															<span>माध्यमिक परीक्षा का  विवरण देखें बी.एस.ई.आर., अजमेर</span>
														</a>
													</c:if>
												</div>
											</div>
											<div class="col-md-3 deg90">
												<div class="grevanceservices">
													...
													<c:if test="${bill.langCode == 1}">
														<a href="javascript:void(0);" onclick="getSP1('JamabandiHi' , 'jamabandiRecord')"class="panel">
															<img src="img/ror.png" alt="" />
											...
											<div class="col-md-3 deg180">
												<div class="grevanceservices">
													<c:if test="${bill.langCode == 0}">
														<a href="javascript:void(0);" onclick="getSP1('GrievanceStatus' , 'utilityBills')"class="panel">
															<img src="img/Grievance.png" alt="" />
															<span>View Grievance Status</span>
														</a>
													</c:if>
													<c:if test="${bill.langCode == 1}">
														<a href="javascript:void(0);" onclick="getSP1('GrievanceStatusHi' , 'utilityBills')"class="panel">
															<img src="img/Grievance.png" alt="" />
															<span>शिकायत की स्थिति देखें</span>
														</a>
													</c:if>
												</div>
											</div>
								...
								<div class="button_div">
									<a href="javascript:void(0);" onclick="getSP1('GovernmentServiceProvider' , 'utilityBills')" class="panel">
										<c:if test="${bill.langCode == 0}"><img src="img/new/back.png" alt="" /></c:if>
										<c:if test="${bill.langCode == 1}"><img src="img/new/backhindi.png" alt="" /></c:if>
									</a>
								</div>
							</div>
						</div>
