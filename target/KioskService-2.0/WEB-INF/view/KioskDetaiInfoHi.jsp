...
<div>
																...
																<table class="gridview" cellspacing="0" cellpadding="0"
																	style="width: 100%; border-collapse: collapse;">
																		...
																		<tr>
																			...
																			<th style="width: 10%;">LSP NAME</th>
																			<th style="width: 5%;">Email</th>
																			<th style="width: 10%;">PhoneNumber1</th>
																			<th style="width: 15%;">PhoneNumber2</th>
																		...
																		<c:forEach varStatus="i" items="${requestScope.list}"
																			...
																			<tr style="height: 40px;">
																				...
																				<td align="center">${user.lspName}</td>
																				<td align="center">${user.email}</td>
																				<td align="center">${user.phoneNumber1}</td>
																				<td align="center">${user.phoneNumber2}</td>
							...
							<div class="button_div">
								<a href="InformationPanchayatServiceHi" class="panel"> <img src="img/new/backhindi.png"
									alt=""></a>
