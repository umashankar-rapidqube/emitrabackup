...
<body style="background: url(img/inner-bg.png); background-size: cover;">
							...
							<div class="container main_row">
								<div class="row circle-container">
									<div class="billmidmain">
										<h1 class="">सम्पर्क शिकायत की स्थिति देखें</h1>
										...
										<div class="col-md-6">
											<label><input type="radio" class="form-switch"
												...
												checked>शिकायत संख्या </label>
												</div> <div class="col-md-4"><label><input
												type="radio" class="form-switch" name="Grievance"
												value="green" data-id="b" id="notchecked"> मोबाइल नंबर
												</label>
												</div>
												</div>
													...
													<div class="col-md-6">
														<div class="billid">
															<label for="exampleInputEmail1"
																class="bmd-label-floating">शिकायत संख्या<span
														...
														<div class="billidright">
															<div class="form-group">
																<input type="text" class="form-control"
																	...
																	name="GrievanceId" id="gid"
																	placeholder="शिकायत संख्या दर्ज करें" VALUE="" required>
																<div class="billidright" id="errTokenId1"></div>
															</div>
														</div>
													</div>
												</div>
											...
											<div class="feildone" style="text-align: center" id="mobile">
												<div class="col-md-8 col-md-offset-3">
													<div class="col-md-3">
														<div class="billid">
															<label for="exampleInputEmail1"
																class="bmd-label-floating">मोबाइल नंबर <span
																style="color: red">*</span></label>
														</div>
													</div>
													<div class="col-md-4">
														<div class="billidright">
															<div class="form-group">
																...
																<input type="text" class="form-control"
																	required="required" maxlength="10" placeholder="मोबाइल नंबर दर्ज करें"
																	autocomplete="off" name="mobileNo" id="MobileNo1"
																	value="" onkeypress="return isNumberKey(event, this)" required >
													...
													<div class="col-md-4">
														<div class="billid">
															...
															<input type="submit" name="ctl00$Content1$btnSendOTP"
																...
																id="Content1_btnSendOTP" tabindex="5" class="btnOTP">
											...
											<div class="twobtn">
												<button class="btn btn-default getone" id="checkForm"
													type="button">आगे बढ़ें</button>

												<button class="btn btn-default btn-raised getone"
													id="ResetButton" type="reset">रीसेट</button>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer" style="text-align: center">
					<button type="button" class="btn btn-default getone" id="submitOtp">आगे
						बढ़ें OTP</button>
	...
	<script type="text/javascript">
		...
		$("#submitOtp")
				.click(
						function() {	var mobileOtp = document
						...
						if (mobileOtp === otpMobile) {
							...
							document.getElementById('updateMessage1').innerHTML = "गलत OTP डाला गया है..!!!";
						}, 3000);
						}
				...
				.click(
						function() {
							...
							if ($("#gid").val().trim() == '') {
								...
								$("#updateMessage")
												.html(
														'<p style="">कृपया  शिकायत संख्या   दर्ज करें</p>');
										$("#gid").focus();
				...
				.on(
						...
						function() {
							...
							if ($("#MobileNo1").val().trim() == '') {
								...
								$("#updateMessage")
										.html(
												'<p style="">* कृपया  मोबाइल नंबर दर्ज करें</p>');
								$("#MobileNo1").focus();
								return false;
						}, 3000);
							}
