...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function printReceipt(pdfUrl) {
				...
				xhttp.open("POST", "receiptPrintCertificate?transId=" + transId
						+ "&pdfUrl=" + pdfUrl, true);
				xhttp.send();
			}
		</script>
	...
	<body style="background: url(img/inner-bg.png); background-size: cover;">
											...
											<div class="modal-content">
												<div class="modal-body">
													<div class="row">
														<div class="col-md-12 text-center">
															...
															<p>
																जारी रखने के लिए सही दबाएं और <i class="fa fa-inr"
																	aria-hidden="true"></i> <span id="Pamt"></span> नोट नकद
																संग्रह युक्ति में जमा करें
															</p>
														</div>
													</div>
												</div>
												<div class="modal-footer text-center"
													...
													<a href="index" class="panel">
														<button class="btn btn-default getone" id="cancel">रद्द
															करना</button>
													</a>
												</div>
											</div>
		...
		<input type="hidden" value="0" name="emitraCertiTransactionId"
			id="emitraCertiTransactionId">
		...
		<form id="certipayment">
			...
			<input type="hidden" name="billAmount" value="0" id="csd1"> <input
				type="hidden" name="certiServiceName" id="serviceName"> <input
				type="hidden" value="1" name="langCode"> <input type="hidden"
				value="${serviceID}" name="serviceProviderID">
		</form>
	
		<form id="bhamashahPayment">
			<input type="hidden" name="transId" value="0" id="transId"> <input
				type="hidden" name="eMitratransId" value="0" id="eMitratransId">
