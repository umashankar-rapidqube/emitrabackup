...
//									  						memberData['ADDHAR_NO'] = document.getElementById("aadharNo").value//for temporary purpose;
	...
	//											  				  			document.getElementById('updateMessage').innerHTML = "यह मोबाइल नंबर पहले से मौजूद है ।";
											  				  			...
											  				  			document.getElementById('updateMessage').style = "color :red; display :block;";
												  				  		if(langCode == "ENG"){
												  				  			document.getElementById('updateMessage').innerHTML = "There's an error occur in network, please try again after some time.";
												  				  		}
												  				  		if(langCode == "HND"){
												  				  			document.getElementById('updateMessage').innerHTML = "नेटवर्क में एक त्रुटि हुई है, कृपया कुछ समय बाद पुनः प्रयास करें।";
												  				  		}
