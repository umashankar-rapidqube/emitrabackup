	...
	public String getXmlForAadharOtpGen(String aadharNo) {
		...
		try {
	         ...
	         output = getStringFromXml(doc);;
	    	  ...
	    	  log.error("AadharService, Exception in getXmlForAadharOtpGen :", e);
	         /*e.printStackTrace();*/
	      }
...
*/				
			...
			json.put("Message", "Problem in the UID server ,Please try again!");
		}
		finally
		{
			try {
	...
	public String getXmlForAadharOtpAuthEkyc(String aadharNo , String txnId , String otp , String webPath) {
		...
		try {
	         ...
	         output = getStringFromXml(doc);
	    	  ...
	    	  log.error("AadharService, Exception in getXmlForAadharOtpAuthSimple :", e);
	         /*e.printStackTrace();*/
	      }
	...
	private static Element prepareAuthRequestBio(Element pid, Element authrequest , String timeStamp , Document doc , String webPath) {
		...
		try {
			...
			log.error("AadharService, Exception in prepareAuthRequestBio :" +e.getMessage());
			/*e.printStackTrace();*/
	...
	public static byte[] generateSha256Hash(byte[] message) {
        ...
        try {
        	...
        	log.error("AadharService, Exception in generateSha256Hash :"+ e.getMessage());
            /*e.printStackTrace();*/
        }
        return hash;
    }
	...
	public static String getStringFromXml(Object object) {
		...
		try {
			...
			// TODO Auto-generated catch block
			log.error("AadharService, Exception in getStringFromXml :"+ e.getMessage());
			/*e.printStackTrace();*/
		}
		return blockElement;
	}
