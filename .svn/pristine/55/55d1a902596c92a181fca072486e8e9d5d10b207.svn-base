...
public class Encrypter {
    ...
    static final Logger logger = Logger.getLogger(Encrypter.class);
    ...
    public Encrypter(String publicKeyFileName) {
    	...
    	//failIfDirectoryTraversal(publicKeyFileName);
        ...
        try {
        	...
        	logger.error("Encrypter, Exception in Encrypter : "+e.getMessage());
    ...
    public byte[] encryptUsingSessionKey(byte[] skey, byte[] data, String tStamp) throws InvalidCipherTextException {
        ...
        try {
        	...
        	logger.error("Encrypter, Exception in encryptUsingSessionKey : "+e.getMessage());
            /*e.printStackTrace();*/
        }
    ...
    public byte[] encryptUsingSessionKeyNoAdd(byte[] skey, byte[] data, String tStamp) throws InvalidCipherTextException {
        ...
        try {
        	...
        	logger.error("Encrypter, Exception in encryptUsingSessionKeyNoAdd : "+e.getMessage());
            /*e.printStackTrace();*/
        }
        byte[] ivBytes = new byte[IV_SIZE_BITS / 8];
        byte[] aadBytes = new byte[AAD_SIZE_BITS / 8];
    ...
    public void failIfDirectoryTraversal(String relativePath)
    {
        ...
        {
        	logger.error("Encrypter, Exception in failIfDirectoryTraversal : "+e.getMessage());
