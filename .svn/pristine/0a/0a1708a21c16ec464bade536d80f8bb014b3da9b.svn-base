...
function submit() {
	//alert("csd");
// 	document.getElementById('cardpayment').action = "http://uat.rpp.rajasthan.gov.in/payments/v1/init";//Testing
	document.getElementById('cardpayment').action = "https://rpp.rajasthan.gov.in/payments/v1/init";//Production
